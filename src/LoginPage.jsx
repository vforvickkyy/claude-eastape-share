...
import { EnvelopeSimple, Lock, Warning, Eye, EyeSlash } from "@phosphor-icons/react";
    ...
    <div className="auth-page">
      ...
      >
        <div className="auth-card-heading">
          ...
          <p className="auth-card-sub">Sign in to your Eastape account</p>
        </div>
          ...
          <div className="form-group">
            ...
            <div className="form-input-wrap">
              ...
              <input
                ...
                autoComplete="current-password" className="form-input" placeholder="••••••••"
