...
export default function ProjectSettingsPage() {
  ...
  useEffect(() => {
    if (project) {
      ...
      setIcon(project.icon || ICON_OPTS[0]);
    }
  }, [project]);
  ...
  async function handleSave(e) {
    ...
    try {
      await projectsApi.update(projectId, {
        ...
        due_date: dueDate || null, status, color, icon,
      });
      setSaved(true);
      refetch();
  ...
  return (
    <div className="project-settings-tab">
      <form onSubmit={handleSave}>
        <h3 className="tab-section-title">General</h3>
      ...
      <div className="danger-zone">
        <h3 className="tab-section-title danger-title">Danger Zone</h3>
